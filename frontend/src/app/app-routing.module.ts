...
const routes: Routes = [
    ...
    {path: 'profile-address', loadChildren: './pages/profile-address/profile-address.module#ProfileAddressPageModule'},
    {
        ...
        loadChildren: './pages/profile-password/profile-password.module#ProfilePasswordPageModule'
    },
    {
        path: 'appointment-view/:aid',
        loadChildren: './pages/appointment-view/appointment-view.module#AppointmentViewPageModule'
    },
    {
    ...
    {path: 'filter', loadChildren: './pages/filter/filter.module#FilterPageModule'},
    {
        ...
        loadChildren: './pages/filter-result/filter-result.module#FilterResultPageModule'
    },
];
