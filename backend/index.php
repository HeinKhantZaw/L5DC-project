...
<head>
    ...
    <title>Welcome to LifeCare Clinic</title>
    ...
    box-shadow: 0px 25px 10px -15px rgba(0,0,0,0.08);
        ...
        .nav-dropdown {
            ...
            border: 0;
            padding: 0 1.2rem;
            background: linear-gradient(to right, #2b5daf 0%, #1c4c9c 100%);
        ...
        .btn-primary {
            color: #fff;
            background: linear-gradient(to right, #2b5daf 0%, #1c4c9c 100%) !important;
            border-color: #688dca !important;
        }
        ...
        .jumbotron {
            /* padding: 18rem 0; */
            padding: 20% 0;
            background: url('./assets/img/cardiologist_17.jpg');
...
<div class="wrapper">
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#">LifeCare <b>Clinic</b></a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown nav-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="http://localhost:4200/" target="_blank">Patient</a>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h2 class="jumbotron-title">Appointments made easy</h2>
            <p>Say goodbye to long wait times and busy phone lines</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row slideanim">
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/search.jpg" width="150" height="150">
                            <h5 class="card-title">Search for doctors</h5>
                            <p class="card-text"> You can search for doctors by name, specialty, or clinic location.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/doctor-profile.jpg" width="150" height="150">
                            <h5 class="card-title">See doctor profile</h5>
                            <p class="card-text"> You can see the doctor's profile and availability before
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/appointment.jpg" width="150" height="150">
                            <h5 class="card-title">Make an appointment</h5>
                            <p class="card-text"> You can make an appointment with a doctor by using the online
                                appointment system.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/rating.jpg" width="150" height="150">
                            <h5 class="card-title">Rate your doctor</h5>
                            <p class="card-text"> Rate your doctor and give your feedback after your appointment.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section id="patient">
        <div class="container">
            <div class="row slideanim">
                ...
                <div class="col-7">
                    <h1>Download the LifeCare app</h1>
                    <p>Book appointments and medical checkups<br>Order medicines and consult doctors online</p>
                    <a href="http://localhost:4200/" target="_blank"><img src="./assets/img/play-store.png"
                                                                          alt="Play Button" width="180px"></a>
                    <a href="http://localhost:4200/" target="_blank"><img src="./assets/img/app-store.png"
                                                                          alt="Play Button" width="140px"></a>
                </div>
            </div>
        </div>
    </section>
...
<footer class="footer">
    <div class="upper-footer">
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <a class="navbar-brand" href="#">LifeCare Clinic</a>
                </div>
                <div class="col-3">
                    <h5>Product</h5>
                    <ul>
                ...
                <div class="col-3">
                    ...
                    <ul>
                        <li class=""><a href="#">LifeCare@gmail.com</a></li>
