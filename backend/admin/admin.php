                ...
                <div class="card-body">
                    <div class="data-tables">
                        ...
                        <table id="datatable" class="table" style="width:100%">
                            ...
                            <tbody>
                            <?php
                            $tresult = $connection->query("SELECT * FROM admin");
                            if ($tresult->num_rows === 0) {
                                ...
                                while ($row = $tresult->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="admin-edit.php?aid=<?php echo $encrypt_id; ?>"
                                               class="btn btn-sm btn-secondary"><i class="fa fa-pen"></i> Edit</a></td>
                                    </tr>
                                    <?php
                                }
                            }
