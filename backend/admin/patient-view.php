...
$result = mysqli_query($connection, "SELECT * FROM patients WHERE patient_id = $pid");
            ...
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <h5 class="card-title mr-auto">View Patient
                            : <?php echo strtoupper($row["patient_firstname"] . ' ' . $row["patient_lastname"]) ?></h5>
                    </div>
                    <div class="card-inner">
                        <!-- View -->
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-info"
                                   role="tab"
                                   aria-controls="nav-home" aria-selected="true">Patient Info</a>
                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab"
                                   href="#nav-appointment" role="tab"
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-appointment" role="tabpanel"
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    $result = mysqli_query($connection, "SELECT * FROM appointment JOIN doctors ON appointment.doctor_id = doctors.doctor_id WHERE patient_id = '" . $pid . "'");
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        if ($result->num_rows == 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row["app_time"] ?></td>
                                                <td>
                                                    Dr. <?= $row["doctor_firstname"] . ' ' . $row["doctor_lastname"] ?></td>
