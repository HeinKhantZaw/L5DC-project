    ...
    <div class="page-content" id="content">
        ...
        if (isset($_POST['savebtn'])) {
            ...
            if (count($errors) == 0) {
                ...
                $sql = "INSERT INTO speciality (speciality_name, speciality_icon) VALUES ('" . $add_speciality . "', '" . $image . "' )";
                $sqlbackup = "INSERT INTO speciality_backup (speciality_name) VALUES ('" . $add_speciality . "')";

                if (!$result = $connection->query($sql)) {
                    ?>
                    <script>Swal.fire("Error", "Running the query <?php echo $connection->error; ?>", "error")</script><?php
                } else {
                    ...
                    <div class="card-body">
                        <form name="add_form" class="inline-form" method="POST"
                            ...
                            <div class="form-group row">
                                <label for="inputSpeciality"
                                       class="col-sm-3 col-form-label text-right">Speciality</label>
                                <div class="col-sm-6">
                                    <input type="text" name="inputSpeciality" id="inputSpeciality"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" name="inputIcon" id="inputIcon" accept="image/*"
                                           onchange="openFile(event)" class="form-control form-control-sm">
                                </div>
                                <script>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 text-center">
                                    <img src="../assets/img/empty/empty-image.png" id="output"
                                         class="img-fluid thumbnail" width="52px">
                                </div>
                            </div>
                            <div class="d-flex justify-content-md-center pt-2">
                                <button type="reset" class="btn btn-light btn-sm px-5 mr-2" name="clearbtn">Clear
                                </button>
                            ...
                            <table id="datatable" class="table" style="width:100%">
                                ...
                                while ($table_row = mysqli_fetch_assoc($table_result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../uploads/icons/<?php echo $table_row["speciality_icon"]; ?>"
                                                 alt="<?php echo $table_row["speciality_icon"]; ?>" width="40px"></td>
                                        <td><?php echo $table_row["speciality_name"]; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                                    data-target="#edit-modal<?php echo $table_row["speciality_id"]; ?>">
                                                <i class="fa fa-edit"></i> Edit
                                            </button>
                                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"
                                                    data-target="#deletemodal<?php echo $table_row["speciality_id"]; ?>">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="edit-modal<?php echo $table_row["speciality_id"]; ?>"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form name="update_form" method="POST"
                                                    ...
                                                    <div class="modal-body">
                                                        <small class="form-text text-muted">ID
                                                            #<?php echo $table_row["speciality_id"]; ?></small>
                                                        <input type="hidden" name="speciality_id"
                                                               value="<?php echo $table_row["speciality_id"]; ?>">
                                                        <input type="text" name="update_speciality" class="form-control"
                                                               value="<?php echo $table_row["speciality_name"]; ?>">
                                                        <br/>
                                                        <small class="form-text text-muted">Image Icon</small>
                                                        <input type="file" name="inputUpdateIcon" class="form-control"
                                                               accept="image/*" onchange="iconFile(event)">
                                                        <br/>
                                                        <div style="display: flex; justify-content: center;">
                                                            <img src="../uploads/icons/<?= $table_row["speciality_icon"] ?>"
                                                                 id="icon_output" class="img-fluid thumbnail"
                                                                 width="52px">
                                                        </div>
                                                        <script>
                                    ...
                                    <!-- End Modal -->
                                    <div class="modal fade" id="deletemodal<?= $table_row['speciality_id'] ?>"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" name="speciality_id"
                                                               value="<?= $table_row['speciality_id'] ?>">
                                                        Are you sure you want to delete
                                                        <strong><?= $table_row['speciality_name'] ?></strong> ?
                                                    </div>
