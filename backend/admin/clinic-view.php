    ...
    <div class="page-content" id="content">
        ...
        <div class="row">
            <div class="col-12 mt-3 mb-3">
                <a href="./clinic-edit.php" class="btn btn-primary btn-sm pull-right px-5" data-toggle="modal"
                   data-target="#exampleModal">Approve</a>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"
                                        id="exampleModalLabel"><?php echo $row["clinic_name"]; ?></h5>
            ...
            <div class="col-12">
                <div class="owl-carousel">
                    <?php
                    $img_result = mysqli_query($connection, "SELECT * FROM clinic_images WHERE clinic_id = " . $row["clinic_id"] . " ");
            ...
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        $hour_result = mysqli_query($connection, "SELECT * FROM business_hour WHERE clinic_id = " . $row["clinic_id"] . " ");
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <p class="mb-2"><i
                                    class="fas fa-map-marker-alt fa-fw"></i> <?php echo $row["clinic_address"] . ', ' . $row["clinic_state"] . ', ' . $row["clinic_zipcode"] . ', ' . $row["clinic_city"] ?>
                        </p>
                        <iframe width='100%' height='300' frameborder='0' style='border:0'
                                src='https://www.google.com/maps/embed/v1/place?key=AIzaSyAGx-OjyNn10KsJ_OsE7cl2_qxg6mNBZyI&q="<?= $row['clinic_address'] ?>+","+<?= $row['clinic_city'] ?>+","+<?= $row['clinic_state'] ?>+","+<?= $row['clinic_zipcode'] ?>+"+Yangon'
...
if (isset($_POST['approvebtn'])) {
    ...
    $appstmt = $connection->prepare("UPDATE clinics SET clinic_status = ? WHERE clinic_id = ?");
