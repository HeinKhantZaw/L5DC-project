...
if (array_key_exists("adminlogin", $_SESSION) && $_SESSION["adminlogin"] == 1) {
                ...
                <form name="login_form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" placeholder="Enter email" value="admin@gmail.com">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" id="exampleInputPassword1"
                               placeholder="Password" value="123!@#LcAdmin">
                    </div>
...
if (isset($_POST['loginbtn'])) {
    ...
    $check = $connection->prepare("SELECT * FROM admin WHERE admin_email = ? ");
    ...
    $statement = $connection->prepare("SELECT * FROM admin WHERE admin_email = ? AND admin_pass = ? ");
