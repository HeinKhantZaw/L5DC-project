                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="inputFirstName" class="form-control <?= $classFName ?>"
                                               id="inputFirstName" placeholder="Enter First Name"
                                               value="<?php echo $doctor_row["doctor_firstname"]; ?>">
                                        <?php echo $errFName; ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputLastName">Last Name/Surname</label>
                                        <input type="text" name="inputLastName" class="form-control <?= $classLName ?>"
                                               id="inputLastName" placeholder="Enter Last Name"
                                               value="<?php echo $doctor_row["doctor_lastname"]; ?>">
                                        <?php echo $errLName; ?>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="inputSpeciality" id="inputSpeciality"
                                                class="form-control selectpicker <?= $classSpec ?>"
                                                data-live-search="true">
                                            <option value="" selected disabled>Choose</option>
                                            <?php
                                            $table_result = mysqli_query($connection, "SELECT * FROM speciality");
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="inputYrsExp" class="form-control <?= $classYears ?>"
                                               id="inputYrsExp" placeholder="Enter Years Experience"
                                               value="<?php echo $doctor_row["doctor_experience"]; ?>">
                                        <?= $errYears ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputFee">Consultant Fees</label>
                                        <input type="text" name="inputFee" class="form-control <?= $classFee ?>"
                                               id="inputFee" placeholder="Enter Consultant Fees"
                                               value="<?= $doctor_row["consult_fee"]; ?>">
                                        <?= $errFee ?>
                                    </div>
                                </div>
                                <!-- End Add Doctor -->
                                    ...
                                    <div class="file-tab">
                                        <label class="btn btn-sm btn-primary btn-block btn-file">
                                            ...
                                            <input type="file" name="inputAvatar" id="inputAvatar" accept="image/*"
                                                   ...
                                                   value="<?= $doctor_row["doctor_avatar"]; ?>">
                                        </label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="inputLanguages">Languages Spoke</label><small class="text-muted m-2">We'll
                                    ...
                                    foreach ($select_lang as $lang_value) {
                                        ...
                                        <div class="col">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="inputLanguages[]" id="customCheck<?= $i ?>"
                                                       class="custom-control-input <?= $classSpoke ?>"
                                                       value="<?= $lang_value ?>" <?= $checked ?>>
                                                <label class="custom-control-label"
                                                       for="customCheck<?= $i ?>"><?= $lang_value ?></label>
                                            </div>
                                        </div>
                                        <?php
                                        $i++;
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="inputDesc" name="inputDesc"
                                          rows="3"><?php echo $doctor_row["doctor_desc"]; ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="inputDOB" class="form-control" id="datepicker"
                                           placeholder="Enter DOB" value="<?php echo $doctor_row["doctor_dob"]; ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="inputGenderMale" name="inputGender"
                                                       class="custom-control-input"
                                                       value="male" <?= $doctor_row["doctor_gender"] == "male" ? "checked" : "" ?>>
                                                <label class="custom-control-label" for="inputGenderMale">Male</label>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="inputGenderFemale" name="inputGender"
                                                       class="custom-control-input"
                                                       value="female" <?= $doctor_row["doctor_gender"] == "female" ? "checked" : "" ?>>
                                                <label class="custom-control-label"
                                                       for="inputGenderFemale">Female</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="inputContactNumber"
                                           class="form-control <?= $classContact ?>" id="inputContactNumber"
                                           placeholder="Enter Phone Number"
                                           value="<?php echo $doctor_row["doctor_contact"]; ?>">
                                    <?= $errContact ?>
                                </div>
                            </div>
                        </div>
...
if (isset($_POST["savebtn"])) {
    if (multi_empty($errFName, $errLName, $errSpec, $errYears, $errFee, $errSpoke, $errGender, $errEmail, $errContact)) {
        ...
        if ($_FILES["inputAvatar"]["name"] != "") {
            ...
            $updatestmt = $connection->prepare("UPDATE doctors SET doctor_avatar = ?, doctor_firstname = ?, doctor_lastname = ?, doctor_speciality = ?, doctor_experience = ?, consult_fee = ?, doctor_desc = ?, doctor_spoke = ?, doctor_gender = ?, doctor_dob = ?, doctor_contact = ? WHERE doctor_id = ? ");
            $updatestmt->bind_param("ssssissssssi", $image, $fname, $lname, $speciality, $years, $fees, $desc, $spoke, $gender, $dob, $contact, $doctor_row['doctor_id']);
        } else {
            $updatestmt = $connection->prepare("UPDATE doctors SET doctor_firstname = ?, doctor_lastname = ?, doctor_speciality = ?, doctor_experience = ?, consult_fee = ?, doctor_desc = ?, doctor_spoke = ?, doctor_gender = ?, doctor_dob = ?, doctor_contact = ? WHERE doctor_id = ? ");
            $updatestmt->bind_param("sssissssssi", $fname, $lname, $speciality, $years, $fees, $desc, $spoke, $gender, $dob, $contact, $doctor_row['doctor_id']);
        }
