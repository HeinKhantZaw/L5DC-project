    ...
    <div class="vertical-nav bg-white sidebar-shadow" id="sidebar">
        ...
        <div class="sidebabr-inner">
            <ul class="nav flex-column bg-white mb-0" id="metismenu">
                ...
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'], 'doctor.php') !== FALSE) {
                    echo 'mm-active';
                } ?>">
                    <a href="doctor.php" class="nav-link"><i class="fas fa-stethoscope mr-3 fa-fw"></i>Profile</a>
                </li>
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'], 'patient-list.php') !== FALSE) {
                    echo 'mm-active';
                } ?>">
                    <a href="patient-list.php" class="nav-link"><i
                                class="fas fa-user-injured mr-3 fa-fw"></i>Patients</a>
                </li>
                ...
                <li class="nav-item <?php if (preg_match('/(schedule)/', $_SERVER["REQUEST_URI"]) == TRUE) {
                    echo 'mm-active';
                } ?>">
                    <a href="#" class="nav-link has-arrow" aria-expanded="false"><i
                                class="fa fa-user-clock mr-3 fa-fw"></i>Schedule</a>
                    <ul class="side-collapse">
                        <a href="sch-list.php" class="nav-link"><i class="far fa-calendar mr-3 fa-fw"></i>Manage
                            Schedule</a>
                ...
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'], 'treatment.php') !== FALSE) {
                    echo 'mm-active';
                } ?>">
                    <a href="treatment.php" class="nav-link"><i class="fa fa-medkit mr-3 fa-fw"></i>Medical
                        Conditions</a>
                </li>
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'], 'review.php') !== FALSE) {
                    echo 'mm-active';
                } ?>">
