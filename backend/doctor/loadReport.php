...
if (!empty($datefrom) && !empty($dateto)) {
    $statement = $connection->prepare("SELECT * FROM appointment, patients WHERE appointment.patient_id = patients.patient_id AND appointment.doctor_id = ? AND appointment.app_date BETWEEN ? AND ? ");
    $statement->bind_param("sss", $id, $datefrom, $dateto);
