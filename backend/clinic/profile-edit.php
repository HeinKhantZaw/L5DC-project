    ...
    <div class="page-content" id="content">
        ...
        if (isset($_POST["savebtn"])) {
            ...
            if (multi_empty($errName, $errContact, $errEmail, $errAddress, $errCity, $errTownship, $errZipcode)) {
                $clinicstmt = $connection->prepare("UPDATE clinics SET clinic_name = ?, clinic_email = ?, clinic_contact = ?, clinic_address = ?, clinic_city = ?, clinic_state = ?, clinic_zipcode = ? WHERE clinic_id = ?");
                $clinicstmt->bind_param("sssssssi", $clinic_name, $email, $contact, $address, $city, $township, $zipcode, $clinic_row['clinic_id']);
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form name="imgform" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" name="inputImageUpload[]" class="custom-file-input"
                                           id="inputImageUpload" multiple onchange="previewImage()">
                            ...
                            <div class="row">
                                ...
                                if ($count == 0) {
                                    echo '<div class="col mt-2" id="no-img-txt">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="inputTownship" class="form-control input"
        ...
        function previewImage() {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                reader.onload = function (event) {
                    ...
                    img.className = "img-thumbnail col-sm-3";
                    previewContainer.appendChild(img);
                };
                reader.readAsDataURL(file);
            }
            // remove no-img-txt
            let noImgTxt = document.getElementById('no-img-txt');
            noImgTxt.style.display = 'none';
        }
    </script>
    <script>
        $(function () {
