        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="owl-carousel">
                    <?php
                    $img_result = mysqli_query($connection, "SELECT * FROM clinic_images WHERE clinic_id = " . $clinic_row["clinic_id"] . " ");
            ...
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        $hour_result = mysqli_query($connection, "SELECT * FROM business_hour WHERE clinic_id = " . $clinic_row["clinic_id"] . " ");
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <p class="mb-2"><i
                                    class="fas fa-map-marker-alt fa-fw"></i> <?php echo $clinic_row["clinic_address"] . ', ' . $clinic_row["clinic_state"] . ', ' . $clinic_row["clinic_zipcode"] . ', ' . $clinic_row["clinic_city"] ?>
                        </p>
                        <iframe width='100%' height='300' frameborder='0' style='border:0'
                                src='https://www.google.com/maps/embed/v1/place?key=AIzaSyAGx-OjyNn10KsJ_OsE7cl2_qxg6mNBZyI&q="<?= $clinic_row['clinic_address'] ?>+","+<?= $clinic_row['clinic_city'] ?>+","+<?= $clinic_row['clinic_state'] ?>+","+<?= $clinic_row['clinic_zipcode'] ?>+"+Yangon'
...
if (isset($_POST["savebtn"])) {
    $clinic_name = mysqli_real_escape_string($connection, $_POST["inputClinicName"]);
    $contact = mysqli_real_escape_string($connection, $_POST["inputContact"]);
    $fax = mysqli_real_escape_string($connection, $_POST["inputFax"]);
    $email = mysqli_real_escape_string($connection, $_POST["inputEmailAddress"]);

    $opens = $connection->real_escape_string($_POST["inputOpensHour"]);
    $close = $connection->real_escape_string($_POST["inputCloseHour"]);

    $address = mysqli_real_escape_string($connection, $_POST["inputAddress"]);
    $city = mysqli_real_escape_string($connection, $_POST["inputCity"]);
    if (!empty($_POST['inputTownship'])) {
        $township = $_POST['inputTownship'];
    } else {
        $township = "";
    }
    $zipcode = mysqli_real_escape_string($connection, $_POST["inputZipCode"]);
...
if (isset($_POST["uploadbtn"])) {
    $filename = $connection->real_escape_string($_POST["inputImageUpload"]);
