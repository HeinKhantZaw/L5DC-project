...
if (isset($_POST["savebtn"])) {
    ...
    if (multi_empty($errFName, $errLName, $errSpec, $errYears, $errFee, $errSpoke, $errGender, $errEmail, $errContact, $errImage)) {
        ...
        $statement->bind_param("ssssissssssssi", $image, $fname, $lname, $speciality, $years, $desc, $spoke, $gender, $dob, $email, $contact, $fees, $date_created, $clinic_row['clinic_id']);
        if ($statement->execute()) {
            ...
            $expries = date("U") + 86400; // expires after one day
